...
from bpy.types import Operator, OperatorFileListElement,PropertyGroup,AddonPreferences
from bpy_extras.io_utils import ExportHelper, ImportHelper, orientation_helper
...
from .datastructures import SemanticRemapItem, game_enums, silly_lookup
...
class Import3DMigotoFrameAnalysis(
    Operator, ImportHelper, IOOBJOrientationHelper
):
