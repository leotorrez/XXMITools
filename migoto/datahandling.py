...
from bpy.props import BoolProperty, EnumProperty, IntProperty, PointerProperty, StringProperty, CollectionProperty
...
def generate_mod_folder(path, character_name, no_ramps, delete_intermediate, credit, copy_textures, game:GameEnum):
    ...
    ini_data = textwrap.dedent(f'''; {character_name}\n
; Constants -------------------------\n{constant_ini}
